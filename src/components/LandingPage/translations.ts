...
const translations: Record<string, Translations> = {
  vi: {
    ...
    curriculum: {
      ...
      step1Title: "Cài đặt",
      step1Description: "Cài đặt công cụ Aiken & Rust.",
      step2Title: "Cú pháp",
      step2Description: "Biến, Kiểu dữ liệu và Hàm.",
      step3Title: "Validators",
      step3Description: "Hiểu về Datum, Redeemer, Context.",
      step4Title: "Kiểm thử",
      step4Description: "Viết unit test mạnh mẽ.",
      step5Title: "Dự án",
      step5Description: "Xây dựng Hợp đồng Vesting.",
    },
    projects: {
